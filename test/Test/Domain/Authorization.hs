...
authorizationSpec = describe "Lib.Domain.Authorization" $ do
    ...
    let viewUnlockLinksPermSuccess =
            Cap.OverviewPerms
                { viewUnlockLinksPerm = Just Cap.ViewUnlockLinks
                , createUnlockLinksPerm = Nothing
                , deleteUnlockLinksPerm = Nothing
                , shareUnlockLinksPerm = Nothing
                }
        viewUnlockLinksPermFail =
            Cap.OverviewPerms
                { viewUnlockLinksPerm = Nothing
    ...
    let createUnlockLinksPermSuccess =
            Cap.OverviewPerms
                { viewUnlockLinksPerm = Nothing
                , createUnlockLinksPerm = Just Cap.CreateUnlockLinks
                , deleteUnlockLinksPerm = Nothing
    ...
    let deleteUnlockLinksPermSuccess =
            Cap.OverviewPerms
                { viewUnlockLinksPerm = Nothing
                , createUnlockLinksPerm = Nothing
                , deleteUnlockLinksPerm = Just Cap.DeleteUnlockLinks
    ...
    let shareUnlockLinksPermSuccess =
            Cap.OverviewPerms
                { viewUnlockLinksPerm = Nothing
                , createUnlockLinksPerm = Nothing
                , deleteUnlockLinksPerm = Nothing
    ...
    let viewArticlesPermSuccess =
            Cap.ArticlesPerms
                { viewArticlesPerm = Just Cap.ViewArticles
        ...
        viewArticlesPermFail =
            Cap.ArticlesPerms
                { viewArticlesPerm = Nothing
    ...
    let changeArticleTitlesPermSuccess =
            Cap.ArticlesPerms
                { viewArticlesPerm = Nothing
                , createArticlesPerm = Nothing
                , changeTitlesPerm = Just Cap.ChangeTitles
    ...
    let changeArticleStatesPermSuccess =
            Cap.ArticlesPerms
                { viewArticlesPerm = Nothing
                , createArticlesPerm = Nothing
                , changeTitlesPerm = Nothing
    ...
    let viewArticlePermArticleSuccess artId =
            Cap.ArticlePerms
                { viewArticlePerm = Just $ Cap.ViewArticle artId
                , changeTitlePerm = Nothing
                , changeStatePerm = Nothing
                , deleteArticlePerm = Nothing
                , shareArticlePerm = Nothing
                }
        viewArticlePermArticleFail artId =
            Cap.ArticlePerms
                { viewArticlePerm = Nothing
    ...
    let changeTitlePermArticleSuccess artId =
            Cap.ArticlePerms
                { viewArticlePerm = Nothing
                , changeTitlePerm = Just $ Cap.ChangeTitle artId
                , changeStatePerm = Nothing
        ...
        changeTitlePermArticleFail artId =
            Cap.ArticlePerms
                { viewArticlePerm = Just $ Cap.ViewArticle artId
                , changeTitlePerm = Nothing
                , changeStatePerm = Just $ Cap.ChangeState artId
    ...
    let changeStatePermArticleSuccess artId =
            Cap.ArticlePerms
                { viewArticlePerm = Nothing
                , changeTitlePerm = Nothing
                , changeStatePerm = Just $ Cap.ChangeState artId
        ...
        changeStatePermArticleFail artId =
            Cap.ArticlePerms
                { viewArticlePerm = Just $ Cap.ViewArticle artId
                , changeTitlePerm = Just $ Cap.ChangeTitle artId
                , changeStatePerm = Nothing
    ...
    let deleteArticlePermArticleSuccess artId =
            Cap.ArticlePerms
                { viewArticlePerm = Nothing
                , changeTitlePerm = Nothing
                , changeStatePerm = Nothing
        ...
        deleteArticlePermArticleFail artId =
            Cap.ArticlePerms
                { viewArticlePerm = Just $ Cap.ViewArticle artId
                , changeTitlePerm = Just $ Cap.ChangeTitle artId
                , changeStatePerm = Just $ Cap.ChangeState artId
    ...
    let shareArticlePermArticleSuccess artId =
            Cap.ArticlePerms
                { viewArticlePerm = Nothing
                , changeTitlePerm = Nothing
                , changeStatePerm = Nothing
        ...
        shareArticlePermArticleFail artId =
            Cap.ArticlePerms
                { viewArticlePerm = Just $ Cap.ViewArticle artId
                , changeTitlePerm = Just $ Cap.ChangeTitle artId
                , changeStatePerm = Just $ Cap.ChangeState artId
...
defaultArticlePermissions artId =
    Cap.ArticlePerms
        (Just $ Cap.ViewArticle artId)
