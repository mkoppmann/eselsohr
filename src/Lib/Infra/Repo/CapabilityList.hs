...
import qualified Lib.Domain.Repo.CapabilityList                      as CapListRepo
...
apply capList = \case
  CapListRepo.AddUnlockLink perm capId cap       -> CapList.addUnlockLink perm capId cap capList
  CapListRepo.RemoveUnlockLink perm capId        -> pure $ CapList.removeUnlockLink perm capId capList
  CapListRepo.AddShareUnlockLinks perm capId cap -> CapList.addShareUnlockLinks perm capId cap capList
  CapListRepo.RemoveShareUnlockLinks perm capId  -> pure $ CapList.removeShareUnlockLinks perm capId capList
  CapListRepo.AddShareArticleList perm capId cap -> CapList.addShareArticleList perm capId cap capList
  CapListRepo.RemoveShareArticleList perm capId  -> pure $ CapList.removeShareArticleList perm capId capList
  CapListRepo.AddShareArticle perm capId cap     -> CapList.addShareArticle perm capId cap capList
  CapListRepo.RemoveShareArticle perm capId      -> pure $ CapList.removeShareArticle perm capId capList
