...
objRefWithAllArticlesPerms = Capability.ArticlesRef
...
objRefWithNoArticlesPerms = Capability.ArticlesRef
  $ Capability.mkArticlesPerms canView canCreate canChangeTitles canChangeStates canDelete canShare
 where
  canView         = False
  canCreate       = False
...
objRefWithAllArticlePerms artId = Capability.ArticleRef artId
...
objRefWithNoArticlePerms artId = Capability.ArticleRef artId
  $ Capability.mkArticlePerms artId canView canChangeTitle canChangeState canDelete canShare
 where
  canView        = False
