...
markArticleAsUnread
  :: ChangeStatePerm -> ArticleList -> Either AppErrorType ArticleList
...
removeArticle perm = wrapMap $ Map.delete artId
  where artId = Authz.deleteArticleId perm
